...
namespace Quantum {
  ...
  public unsafe partial struct Input {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 19249;
        hash = hash * 31 + SelectedChampionId.GetHashCode();
        hash = hash * 31 + OrderSlot1.GetHashCode();
        hash = hash * 31 + OrderSlot2.GetHashCode();
        hash = hash * 31 + OrderSlot3.GetHashCode();
        hash = hash * 31 + OrderSubmit.GetHashCode();
        return hash;
      }
    }
    ...
    public Boolean IsDown(InputButtons button) {
      switch (button) {
        case InputButtons.OrderSubmit: return OrderSubmit.IsDown;
        default: return false;
      }
    }
    public Boolean WasPressed(InputButtons button) {
      switch (button) {
        case InputButtons.OrderSubmit: return OrderSubmit.WasPressed;
        default: return false;
      }
    }
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        var p = (Input*)ptr;
        serializer.Stream.Serialize(&p->OrderSlot1);
        serializer.Stream.Serialize(&p->OrderSlot2);
        serializer.Stream.Serialize(&p->OrderSlot3);
        serializer.Stream.Serialize(&p->SelectedChampionId);
        Button.Serialize(&p->OrderSubmit, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct _globals_ {
    ...
    private fixed Byte _input_[168];
    [FieldOffset(776)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + SelectTurn.GetHashCode();
        hash = hash * 31 + SelectTimer.GetHashCode();
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct BattleState : Quantum.IComponent {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct ChampionStats : Quantum.IComponent {
    public const Int32 SIZE = 64;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + Constitution.GetHashCode();
        hash = hash * 31 + MaxHealth.GetHashCode();
        hash = hash * 31 + AttackPower.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (ChampionStats*)ptr;
        serializer.Stream.Serialize(&p->ChampionId);
        FP.Serialize(&p->AttackPower, serializer);
        FP.Serialize(&p->AttackSpeed, serializer);
        FP.Serialize(&p->Constitution, serializer);
        FP.Serialize(&p->Dexterity, serializer);
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerGameData : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(8)]
    public PlayerRef PlayerRef;
    [FieldOffset(20)]
    public QListPtr<Int32> SelectedChampions;
    [FieldOffset(0)]
    public Int32 SelectedCount;
    [FieldOffset(16)]
    public QListPtr<Int32> BattleOrder;
    [FieldOffset(12)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + SelectedChampions.GetHashCode();
        hash = hash * 31 + SelectedCount.GetHashCode();
        hash = hash * 31 + BattleOrder.GetHashCode();
        hash = hash * 31 + OrderSubmitted.GetHashCode();
        hash = hash * 31 + TeamId.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(FrameBase f, EntityRef entity) {
      SelectedChampions = default;
      BattleOrder = default;
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.PlayerGameData*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerGameData*)ptr;
        serializer.Stream.Serialize(&p->SelectedCount);
        serializer.Stream.Serialize(&p->TeamId);
        PlayerRef.Serialize(&p->PlayerRef, serializer);
        QBoolean.Serialize(&p->OrderSubmitted, serializer);
        QList.Serialize(&p->BattleOrder, serializer, Statics.SerializeInt32);
        QList.Serialize(&p->SelectedChampions, serializer, Statics.SerializeInt32);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct SimpleAI : Quantum.IComponent {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 2791;
        hash = hash * 31 + SearchRadius.GetHashCode();
        hash = hash * 31 + AttackRange.GetHashCode();
        hash = hash * 31 + ThinkTimer.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->SearchRadius, serializer);
        FP.Serialize(&p->ThinkTimer, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial interface ISignalOnChampionSelected : ISignal {
    void OnChampionSelected(Frame f, PlayerRef player, Int32 championId);
  }
  public unsafe partial interface ISignalOnOrderSubmitted : ISignal {
    void OnOrderSubmitted(Frame f, PlayerRef player);
  }
  public unsafe partial interface ISignalOnBattleStart : ISignal {
    void OnBattleStart(Frame f, Int32 round);
  }
  public unsafe partial interface ISignalOnBattleEnd : ISignal {
    void OnBattleEnd(Frame f, Int32 winnerTeam);
  }
  public unsafe partial interface ISignalOnChampionDeath : ISignal {
    void OnChampionDeath(Frame f, EntityRef champion);
  }
  public unsafe partial interface ISignalOnPhaseChanged : ISignal {
    void OnPhaseChanged(Frame f, Int32 newPhase);
  }
  public static unsafe partial class Constants {
  }
  public unsafe partial class Frame {
    private ISignalOnChampionSelected[] _ISignalOnChampionSelectedSystems;
    private ISignalOnOrderSubmitted[] _ISignalOnOrderSubmittedSystems;
    private ISignalOnBattleStart[] _ISignalOnBattleStartSystems;
    private ISignalOnBattleEnd[] _ISignalOnBattleEndSystems;
    private ISignalOnChampionDeath[] _ISignalOnChampionDeathSystems;
    private ISignalOnPhaseChanged[] _ISignalOnPhaseChangedSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalOnChampionSelectedSystems = BuildSignalsArray<ISignalOnChampionSelected>();
      _ISignalOnOrderSubmittedSystems = BuildSignalsArray<ISignalOnOrderSubmitted>();
      _ISignalOnBattleStartSystems = BuildSignalsArray<ISignalOnBattleStart>();
      _ISignalOnBattleEndSystems = BuildSignalsArray<ISignalOnBattleEnd>();
      _ISignalOnChampionDeathSystems = BuildSignalsArray<ISignalOnChampionDeath>();
      _ISignalOnPhaseChangedSystems = BuildSignalsArray<ISignalOnPhaseChanged>();
      _ComponentSignalsOnAdded = new ComponentReactiveCallbackInvoker[ComponentTypeId.Type.Length];
      _ComponentSignalsOnRemoved = new ComponentReactiveCallbackInvoker[ComponentTypeId.Type.Length];
      BuildSignalsArrayOnComponentAdded<Quantum.BattleState>();
      BuildSignalsArrayOnComponentRemoved<Quantum.BattleState>();
      BuildSignalsArrayOnComponentAdded<Quantum.ChampionStats>();
      BuildSignalsArrayOnComponentRemoved<Quantum.ChampionStats>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.PlayerGameData>();
      BuildSignalsArrayOnComponentRemoved<Quantum.PlayerGameData>();
      BuildSignalsArrayOnComponentAdded<Quantum.SimpleAI>();
      BuildSignalsArrayOnComponentRemoved<Quantum.SimpleAI>();
    ...
    partial void SetPlayerInputCodeGen(PlayerRef player, Input input) {
      ...
      i->SelectedChampionId = input.SelectedChampionId;
      i->OrderSlot1 = input.OrderSlot1;
      i->OrderSlot2 = input.OrderSlot2;
      i->OrderSlot3 = input.OrderSlot3;
      i->OrderSubmit = i->OrderSubmit.Update(this.Number, input.OrderSubmit);
    }
    ...
    public unsafe partial struct FrameSignals {
      public void OnChampionSelected(PlayerRef player, Int32 championId) {
        var array = _f._ISignalOnChampionSelectedSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnChampionSelected(_f, player, championId);
          }
        }
      }
      public void OnOrderSubmitted(PlayerRef player) {
        var array = _f._ISignalOnOrderSubmittedSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnOrderSubmitted(_f, player);
          }
        }
      }
      public void OnBattleStart(Int32 round) {
        var array = _f._ISignalOnBattleStartSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnBattleStart(_f, round);
          }
        }
      }
      public void OnBattleEnd(Int32 winnerTeam) {
        var array = _f._ISignalOnBattleEndSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnBattleEnd(_f, winnerTeam);
          }
        }
      }
      public void OnChampionDeath(EntityRef champion) {
        var array = _f._ISignalOnChampionDeathSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnChampionDeath(_f, champion);
          }
        }
      }
      public void OnPhaseChanged(Int32 newPhase) {
        var array = _f._ISignalOnPhaseChangedSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnPhaseChanged(_f, newPhase);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.BattleState), Quantum.BattleState.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.ChampionStats), Quantum.ChampionStats.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.PlayerGameData), Quantum.PlayerGameData.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.SimpleAI), Quantum.SimpleAI.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 5)
        ...
        .Add<Quantum.BattleState>(Quantum.BattleState.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.ChampionStats>(Quantum.ChampionStats.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerGameData>(Quantum.PlayerGameData.Serialize, null, Quantum.PlayerGameData.OnRemoved, ComponentFlags.None)
        .Add<Quantum.SimpleAI>(Quantum.SimpleAI.Serialize, null, null, ComponentFlags.None)
